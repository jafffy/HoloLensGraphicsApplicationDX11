...
using SpherePrecisionExperiment.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using SpherePrecisionExperiment.Content;
#endif

namespace SpherePrecisionExperiment
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class SpherePrecisionExperimentMain : IDisposable
    {
        ...
        public SpherePrecisionExperimentMain(DeviceResources deviceResources)
        {
