...
namespace FrameRateControlExperiment60
{
    /// <summary>
    ...
    {
        private FrameRateControlExperiment60Main main;
        ...
        public void Initialize(CoreApplicationView applicationView)
        {
            ...
            main = new FrameRateControlExperiment60Main(deviceResources);
        }
        ...
        public void Run()
        {
            Stopwatch oneSecondCounter = new Stopwatch();
            oneSecondCounter.Start();

            Stopwatch oneFrameCounter = new Stopwatch();

            double lastTime = oneSecondCounter.Elapsed.TotalSeconds;
            int currentFPS = 0;

            while (!windowClosed)
            {
                double currentTime = oneSecondCounter.Elapsed.TotalSeconds;
                ...
                const int kTargetFrame = 30;
                int idealElapsedTimeForOneFrameInMilli = (int) (1.0 / kTargetFrame * 1000);
                int sleepTime = idealElapsedTimeForOneFrameInMilli - (int) oneFrameCounter.ElapsedMilliseconds;
