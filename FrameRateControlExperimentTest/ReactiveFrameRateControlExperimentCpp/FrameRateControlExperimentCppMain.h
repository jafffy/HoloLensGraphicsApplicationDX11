...
namespace FrameRateControlExperimentCpp
{
    class FrameRateControlExperimentCppMain : public DX::IDeviceNotify
    {
    public:
        FrameRateControlExperimentCppMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~FrameRateControlExperimentCppMain();
