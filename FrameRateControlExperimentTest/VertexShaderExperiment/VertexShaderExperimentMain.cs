...
using VertexShaderExperiment.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using VertexShaderExperiment.Content;
#endif

namespace VertexShaderExperiment
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class VertexShaderExperimentMain : IDisposable
    {
        ...
        public VertexShaderExperimentMain(DeviceResources deviceResources)
        {
