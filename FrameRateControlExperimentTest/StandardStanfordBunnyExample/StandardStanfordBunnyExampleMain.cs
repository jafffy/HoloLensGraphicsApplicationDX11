...
using StandardStanfordBunnyExample.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using StandardStanfordBunnyExample.Content;
#endif

namespace StandardStanfordBunnyExample
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class StandardStanfordBunnyExampleMain : IDisposable
    {
        ...
        public StandardStanfordBunnyExampleMain(DeviceResources deviceResources)
        {
