...
using PixelShaderExperiment.Content;
#endif

namespace PixelShaderExperiment
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class PixelShaderExperimentMain : IDisposable
    {
        private SpinningCubeRenderer        spinningCubeRenderer;

        private MultiPassRenderer           multiPassRenderer;
        ...
        public PixelShaderExperimentMain(DeviceResources deviceResources)
        {
        ...
        public void SetHolographicSpace(HolographicSpace holographicSpace)
        {
            ...
            multiPassRenderer = new MultiPassRenderer(deviceResources);
        ...
        public HolographicFrame Update()
        {
            ...
            timer.Tick(() => 
            {
                ...
                multiPassRenderer.Update(timer);
            });
        ...
        public void OnDeviceLost(Object sender, EventArgs e)
        {
            ...
            multiPassRenderer.ReleaseDeviceDependentResources();
        }
        ...
        public void OnDeviceRestored(Object sender, EventArgs e)
        {
            ...
            multiPassRenderer.CreateDeviceDependentResourcesAsync();
        }
