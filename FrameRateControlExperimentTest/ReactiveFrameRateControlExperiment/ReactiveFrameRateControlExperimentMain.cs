...
using ReactiveFrameRateControlExperiment.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using ReactiveFrameRateControlExperiment.Content;
#endif

namespace ReactiveFrameRateControlExperiment
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class ReactiveFrameRateControlExperimentMain : IDisposable
    {
        ...
        public ReactiveFrameRateControlExperimentMain(DeviceResources deviceResources)
        {
